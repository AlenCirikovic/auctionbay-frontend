...
const ProfileDropdown = ({ isOpen, onClose, onLogout, onProfileSettings }: ProfileDropdownProps) => {
    ...
    return (
        <div ref={dropdownRef} className="flex flex-col justify-center items-center absolute right-[32px] top-[104px] w-[204px] h-[129px] rounded-[16px] p-[16px] gap-[17px]  bg-white  shadow-xl z-50 border border-gray-100">
            ...
            <div className="group flex items-center justify-center w-[172px] h-[40px] min-[40px] rounded-[16px] pt-[8px] pr-[16px] pb-[8px] pl-[16px] gap-[8px] border-[#272D2D] border-2 hover:bg-black cursor-pointer">
                <button
                    onClick={() => {
                        onLogout();
                        onClose();
                    }}
                    className="block w-full text-center px-4 py-2 text-sm text-gray-700 hover:bg-black group-hover:text-white"
                >
                    Log out
                </button>
            </div>
